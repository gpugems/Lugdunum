...
public:
    ...
    void setEnvironmentTexture(const Resource::SharedPtr<SkyBox> environmentTexture);
    ...
    const Resource::SharedPtr<SkyBox> getEnvironmentTexture() const;
...
protected:
    ...
    Resource::SharedPtr<SkyBox> _environmentTexture;
};
